...
/**
 * 
 * An enginexclassloader object is responsible for loading all jrtrace classes that are injected or run in the scope of
 * one specific target system class loader. 
 * 
 * For each classloader in the target system there must be exactly one enginexclassloader
 * 
